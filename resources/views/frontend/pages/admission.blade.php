    ...
    <div class="container">
        ...
        <form action="#" action="{{ route('admission.store') }}" method="POST">
            ...
            <div class="col-md-6 p-4 p-md-5 bg-light">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="father_name_eng" placeholder="Father Name English" value="{{ old('father_name_eng') }}">
                        @error('father_name_eng')
                        <div class="alert alert-danger p-1" style="font-size: 10px">{{ $message }}</div>
                      @enderror
                    </div> 
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Father Name Bangla" name="father_name_bng" value="{{ old('father_name_bng') }}">
                        @error('father_name_bng')
                        <div class="alert alert-danger p-1" style="font-size: 10px">{{ $message }}</div>
                      @enderror
                    </div> 
                    <div class="form-group">
                        <input type="text" class="form-control" name="mother_name_eng" placeholder="Mother Name English" value="{{ old('mother_name_eng') }}">
                        @error('mother_name_eng')
                        <div class="alert alert-danger p-1" style="font-size: 10px">{{ $message }}</div>
                      @enderror
                    </div> 
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Mother Name Bangla" name="mother_name_bng" value="{{ old('mother_name_bng') }}">
            ...
            <div class="col-md-6 p-4 p-md-5 bg-light">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="father_occupation" placeholder="Father Occupation" value="{{ old('father_occupation') }}">
                        @error('father_occupation')
                        <div class="alert alert-danger p-1" style="font-size: 10px">{{ $message }}</div>
                      @enderror
                    </div> 
                    <div class="form-group">
                        <input type="text" class="form-control" name="mother_occupation" placeholder="Mother Occupation" value="{{ old('mother_occupation') }}">
                        @error('mother_occupation')
                        <div class="alert alert-danger p-1" style="font-size: 10px">{{ $message }}</div>
                      @enderror
                    </div> 
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Father NID" name="father_nid" value="{{ old('father_nid') }}">
                        @error('father_nid')
                        <div class="alert alert-danger p-1" style="font-size: 10px">{{ $message }}</div>
                      @enderror
                    </div> 
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Mother NID" name="mother_nid" value="{{ old('mother_nid') }}">
                        @error('mother_nid')
                        <div class="alert alert-danger p-1" style="font-size: 10px">{{ $message }}</div>
                      @enderror
                    </div> 
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Father Telephone/Cell" name="father_contact" value="{{ old('father_contact') }}">
                        @error('father_contact')
                        <div class="alert alert-danger p-1" style="font-size: 10px">{{ $message }}</div>
                      @enderror
                    </div> 
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Mother Telephone/Cell" name="mother_contact" value="{{ old('mother_contact') }}">
                        @error('mother_contact')
                        <div class="alert alert-danger p-1" style="font-size: 10px">{{ $message }}</div>
                      @enderror
                    </div> 
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Father Facebook id (if any)" name="father_fb" value="{{ old('father_fb') }}">
                        @error('father_contact')
                        <div class="alert alert-danger p-1" style="font-size: 10px">{{ $message }}</div>
                      @enderror
                    </div> 
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Mother Facebook id (if any)" name="mother_fb" value="{{ old('mother_fb') }}">
                        @error('mother_contact')
                        <div class="alert alert-danger p-1" style="font-size: 10px">{{ $message }}</div>
                      @enderror
                    </div> 
