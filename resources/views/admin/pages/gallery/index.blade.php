    ...
    <div class="row">
          ...
          <div class="card">
              <div class="card-header">
                <h2 class="card-title">School Photo Gallery </h2>
              </div>
              <!-- form start -->
                  ...
                  <div class="row">
                    ...
                    <div class="col-12 col-md-12">
                     <div class="form-group">
                         ...
                         <input id="my-input" class="form-control-file" type="file" name="image" title ="upload less then 1 mb file">
                         <div class="alert alert-info">upload less then 1 mb file</div>
                         @error('image')
                         <div class="alert alert-danger">{{ $message }}</div>
                       @enderror
                     </div>
        ...
        <div class="col-12 col-md-12 mt-4">
            <div class="card">
                <div class="card-header">
                  <h3 class="card-title">All School Photo</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped dataTable dtr-inline text-center" role="grid" aria-describedby="example1_info">
                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <td style="width: 100px">
                                              <img src="{{ url('storage/galleryImage/'.$item->image) }}" alt="" class="img-fluid">
                                            </td>
                                            <td>
