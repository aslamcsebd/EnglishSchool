...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-12 col-md-12 mt-4">
            <div class="card">
                <div class="card-header">
                  <h3 class="card-title">All About Info</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                                      ...
                                      <tbody>
                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <td  style="width: 100px">
                                              <img src="{{ url('storage/about/'.$item->image) }}" alt="" class="img-fluid">
                                            </td>
                                            <td>
                                              <a href="{{ route('about.edit',$item->id) }}" class="btn btn-primary">Edit</a>
                                                {{-- <button class="btn btn-primary" data-target=".bd-example-modal-lg{{ $item->id }}" data-toggle="modal">Edit</button> --}}
