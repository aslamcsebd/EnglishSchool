    ...
    <div class="row">
          ...
          <div class="card">
              <div class="card-header">
                <h2 class="card-title">Our Administration </h2>
              </div>
              <!-- form start -->
              <form role="form" method="POST" action="{{ route('administration.store') }}" enctype="multipart/form-data">
                  @csrf
                <div class="card-body">
                  <div class="row">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped dataTable dtr-inline text-center" role="grid" aria-describedby="example1_info">
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Degree</th>
                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <td  style="width: 100px">
                                              <img src="{{ url('storage/administration/'.$item->image) }}" alt="" class="img-fluid">
                                            </td>
                                            <td>
                                                <button class="btn btn-primary" data-target="#modal-secondary-{{ $item->id }}" data-toggle="modal">Edit</button>
                                                <form action="{{route('administration.destroy',$item->id)}}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method("DELETE")
                                            ...
                                            <div class="modal-dialog modal-lg">
                                              <div class="modal-content bg-secondary">
                                                ...
                                                <div class="modal-body">
                                                    <form role="form" method="POST" action="{{ route('administration.update',$item->id)}}" enctype="multipart/form-data">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="card-body">
                                                          <div class="row">
